...
[ "_malloc", "_free", "_memory", "___indirect_function_table", "___set_stack_limits", "onRuntimeInitialized" ].forEach(prop => {
...
function findWasmBinary() {
  ...
  return new URL("pathops.wasm", import.meta.url).href;
}
